...
**Atention:** the folder called "dataset" in this repository does not contain the images used in the work. The scripts in this repository expect the images, once downloaded, to be placed in specific directories within that folder.
