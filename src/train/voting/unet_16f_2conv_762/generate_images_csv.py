...
MASKS_PATH = '/home/andre/mask_patches/intersection/'
IMAGES_DATAFRAME = './dataset/images_masks.csv'

RANDOM_STATE = 42

if MASK_ALGORITHM.lower() == 'intersection' or MASK_ALGORITHM.lower() == 'voting':
    masks = glob.glob(os.path.join(MASKS_PATH, '*.tif'))
    print( os.path.join(MASKS_PATH, '*.tif') )
else:
